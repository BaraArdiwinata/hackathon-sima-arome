...
export const theme = createTheme({
  ...
  headings: {
    ...
    sizes: {
      h1: { lineHeight: "1.2", fontSize: "2.5rem" },
      h2: { lineHeight: "1.25", fontWeight: "600", fontSize: "2.0rem" },
      h3: { lineHeight: "1.3", fontWeight: "500", fontSize: "1.5rem" },
      h4: { lineHeight: "1.35", fontWeight: "500" },
    }
  },
  fontSizes: {
