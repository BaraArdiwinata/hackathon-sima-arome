...
export default function LoginPage() {
  ...
  return (
    ...
    >
      <Container size={420}>
        <Title ta="center" mb="xs" style={{ fontFamily: "var(--ds-font-display, serif)", color: "var(--ds-primary)", fontSize: "2.5rem" }}>
          Sima Arôme
        </Title>
        <Text c="dimmed" size="sm" ta="center" mb="xl" style={{ fontFamily: "var(--ds-font-subheader, sans-serif)", fontWeight: 500 }}>
