...
import { useProductions, useProductionPhases, useUpdateProductionPhase, useAllPhases } from '../production/_hooks';
...
export default function TrackingPhasePage() {
  ...
  const { productions, loading: productionsLoading } = useProductions();
  ...
  const handleUpdateStatus = useCallback(async () => {
    ...
    await update(updateTarget.id, { status: newStatus, note: note || undefined });
    closeUpdate();
    refetchPhases();
    notifications.show({
      title: 'Phase Updated',
  ...
  }, [update, updateTarget, newStatus, note, closeUpdate, refetchPhases]);
